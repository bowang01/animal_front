...
<!--      <el-input style="width: 200px" placeholder="Please enter" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload :action="$apiBase + '/donate/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="goods" label="Donated items"></el-table-column>
      <el-table-column prop="time" label="Donation time"></el-table-column>
    ...
    <el-dialog title="Info" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
      <el-form label-width="100px" size="small" style="width: 90%">
        ...
        <el-form-item label="Donated items">
          <el-input v-model="form.goods" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="Donation time">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(this.$apiBase + "/donate/export")
    },
