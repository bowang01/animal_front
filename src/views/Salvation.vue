...
<!--&lt;!&ndash;      <el-input style="width: 200px" placeholder="Please enter" suffix-icon="el-icon-message" class="ml-5" v-model="email"></el-input>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-input style="width: 200px" placeholder="Please enter" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>&ndash;&gt;-->
...
<!--    </div>-->
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="time" label="Discovery Time"></el-table-column>
      <el-table-column prop="person" label="Contact Person"></el-table-column>
      <el-table-column prop="phone" label="Contact"></el-table-column>
      <el-table-column prop="state" label="Resolution Status"></el-table-column>
    ...
    <el-dialog title="Information" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
      <el-form label-width="100px" size="small" style="width: 90%">
        ...
        <el-form-item label="Resolution Status">
          <el-select clearable v-model="form.state" placeholder="Please select">
            <el-option v-for="item in ['Unresolved', 'Resolved']" :key="item" :label="item" :value="item"></el-option>
          </el-select>
        </el-form-item>
