...
<!--      <el-button type="primary" @click="handleAdd">Add <i class="el-icon-circle-plus-outline"></i></el-button>-->
      ...
      <!-- <el-upload :action="$apiBase + '/comment/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
<!--      <el-table-column prop="articleId" label="Article ID"></el-table-column>-->
    ...
    <el-dialog title="Info" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
      <el-form label-width="100px" size="small" style="width: 90%">
        ...
        <el-form-item label="Replier">
          <el-input v-model="form.user" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="Reply time">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(this.$apiBase + "/comment/export")
    },
