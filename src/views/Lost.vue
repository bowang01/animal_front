...
<!--      <el-input style="width: 200px" placeholder="Please enter" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload :action="$apiBase + '/lost/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="nickname" label="Lost Pet Name"></el-table-column>
      ...
      <el-table-column prop="status1" label="Lost / Awaiting Pickup"></el-table-column>
      <el-table-column prop="status2" label="Recovery Status"></el-table-column>
    ...
    <el-dialog title="Information" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
      <el-form label-width="110px" size="small" style="width: 90%">
        <el-form-item label="Lost Pet Name">
        ...
        <el-form-item label="Lost / Awaiting Pickup">
          <el-radio v-model="form.status1" label="Lost">Lost</el-radio>
          <el-radio v-model="form.status1" label="Awaiting pickup">Awaiting pickup</el-radio>
        </el-form-item>
        <el-form-item label="Recovery Status">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(this.$apiBase + "/lost/export")
    },
