...
<!--      <el-input style="width: 200px" placeholder="Please enter" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload :action="$apiBase + '/notice/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(this.$apiBase + "/notice/export")
    },
